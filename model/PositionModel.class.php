...
class PositionModel extends Model {
	public function __construct() {
		parent::__construct();
		$this->_fields = array('id','name','sort');
		$this->_tables = array(DB_FREFIX.'position');
		$this->_check = new PositionCheck();
		list(
				$this->_R['id'],
				$this->_R['name']
	...
	public function findAll() {
		return parent::select(array('id','name','sort'),array('order'=>'sort desc'));
	}
    ...
    public function findAddGoodsPosition() {
        return parent::select(array('id','name'));
    }

    public function findAddDoctorPosition() {
        return parent::select(array('id','name'));
    }
