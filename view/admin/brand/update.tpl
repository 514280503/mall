...
<h2><a href="?a=brand">返回品牌列表</a>项目 -- 修改品牌</h2>

<form method="post" name="add" action="?a=brand&m=update&id={$OneBrand[0]->id}">
	<dl class="form">
		<dd>品牌名称：<input type="text" name="name" value="{$OneBrand[0]->name}" class="text" /> ( * 200内之内)</dd>
