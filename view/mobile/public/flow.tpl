...
<p><a href="?a=cart">返回修改</a> | 项目总计：<strong>{$total}</strong>/元</p>
...
<table id="cart" cellspacing="1">
	...
	<tr><td><input type="radio" name="pay_radio" value="2" title="银行转账/汇款" onclick="changePay(this);" /></td><td>银行转账/汇款</td><td>通过转账汇款，联系客服，提供汇款清单和项目订单号</td><td>2/元</td></tr>
...
<p id="total">项目总计：<strong>{$total}</strong>/元 + 物流运费：<strong></strong>/元 + 支付手续费：<strong></strong>/元</p>
