<?php /* Smarty version 2.6.26, created on 2018-03-25 15:11:27
...
</td><td><?php if ($this->_tpl_vars['value']->first == 1): ?><span class="green">是</span><?php else: ?> <a href="?a=service&m=first&id=<?php echo $this->_tpl_vars['value']->id; ?>
...
" onclick="return confirm('确认删除这个售后服务吗？') ? true : false"><img src="view/admin/images/drop.gif" alt="删除" title="删除" /></a></td></tr>
            <?php endforeach; else: ?>
