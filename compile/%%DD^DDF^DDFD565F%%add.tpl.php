<?php /* Smarty version 2.6.26, created on 2018-03-26 16:18:53
         compiled from admin/doctor/add.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'admin/doctor/add.tpl', 24, false),)), $this); ?>
...
" />
	<dl class="form">
        ...
        <dd>地&ensp;&ensp;&ensp;&ensp;区：<select name="country" id="country">
                ...
                <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['AllCountry']), $this);?>

            </select> <span class="red">[必填]</span>
        </dd>
        <dd>职务职称：<select name="position" id="position">
                <option value="-1" selected="selected">--请选择一个职务职称--</option>
                <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['AllPosition']), $this);?>

            </select> <span class="red">[必填]</span>
        </dd>
        <dd>从业年限：<select name="year" id="year">
                <option value="-1" selected="selected">--请选择一个从业年限--</option>
                <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['AllYear']), $this);?>
