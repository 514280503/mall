<?php /* Smarty version 2.6.26, created on 2018-03-30 16:21:47
...
</td><td><?php echo $this->_tpl_vars['value']->star; ?>
</td><td><?php echo $this->_tpl_vars['value']->date; ?>
</td><td><a href="?a=commend&m=update&id=<?php echo $this->_tpl_vars['value']->id; ?>
"><img src="view/admin/images/edit.gif" alt="编辑" title="编辑" /></a> <a href="?a=commend&m=delete&id=<?php echo $this->_tpl_vars['value']->id; ?>
" onclick="return confirm('确认删除这个项目评论吗？') ? true : false"><img src="view/admin/images/drop.gif" alt="删除" title="删除" /></a></td></tr>
		<?php endforeach; else: ?>
