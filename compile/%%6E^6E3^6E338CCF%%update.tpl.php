<?php /* Smarty version 2.6.26, created on 2018-03-25 16:02:08
...
">
	...
	<dl class="form">
		<dd>名&ensp;&ensp;&ensp;&ensp;称：<?php echo $this->_tpl_vars['OneNav'][0]->name; ?>
 </dd>
		<dd><span class="middle">简&ensp;&ensp;&ensp;&ensp;介：</span><textarea name="info"><?php echo $this->_tpl_vars['OneNav'][0]->info; ?>
