<?php /* Smarty version 2.6.26, created on 2018-03-23 17:08:34
...
" onclick="return confirm('确认删除这个管理员吗？') ? true : false"><img src="view/admin/images/drop.gif" alt="删除" title="删除" /></a></td></tr>
		<?php endforeach; else: ?>
