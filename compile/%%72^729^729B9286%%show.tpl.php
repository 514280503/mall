<?php /* Smarty version 2.6.26, created on 2018-03-25 17:02:15
...
" onclick="return confirm('确认删除这个价格区间吗？') ? true : false"><img src="view/admin/images/drop.gif" alt="删除" title="删除" /></a></td></tr>
            <?php endforeach; else: ?>
