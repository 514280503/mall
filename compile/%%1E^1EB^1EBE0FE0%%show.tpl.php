<?php /* Smarty version 2.6.26, created on 2018-03-22 15:34:26
...
<?php endif; ?>"">添加分类</a>系统 -- 分类列表</h2>

<div id="list">
    <form method="post" action="?a=nav&m=sort">
        <table>
            <tr><th>名称</th><th>简介</th><th>子类</th><?php if ($this->_tpl_vars['OneNav']): ?><th>品牌</th><?php endif; ?><th>排序</th><th>操作</th></tr>
...
?>
                <tr>
                    ...
                    <td><a href="?a=nav&sid=<?php echo $this->_tpl_vars['value']->id; ?>
">查看</a> | <a href="?a=nav&m=add&id=<?php echo $this->_tpl_vars['value']->id; ?>
">添加</a></td>
                    <?php if ($this->_tpl_vars['OneNav']): ?>
                    <td>
                        <?php echo $this->_tpl_vars['value']->brand; ?>
...
" onclick="return confirm('确认删除这个分类吗？') ? true : false"><img src="view/admin/images/drop.gif" alt="删除" title="删除" /></a></td>
                </tr>
                <?php endforeach; else: ?>
